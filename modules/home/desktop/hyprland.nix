  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "SUPER, W, killactive,"
        "SUPER, A, togglespecialworkspace, chatbot"
        "SUPER, M, togglespecialworkspace, message"
        "SUPER, G, togglespecialworkspace, gmail"
        "SUPER, O, togglespecialworkspace, outlook"
      ...
      windowrule = [
        ...
        "match:title Gemini, workspace special:chatbot"
        "match:title Gmail, workspace special:gmail"
        "match:title Outlook (PWA), workspace special:outlook"
        "match:title Discord, workspace special:discord"
