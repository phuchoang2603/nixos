#
# /home/felix/.config/nix/pkgs/ansible-language-server.nix
#
# Pinned version of ansible-language-server from NixOS 25.05
# Source: https://github.com/NixOS/nixpkgs/blob/nixos-25.05/pkgs/by-name/an/ansible-language-server/package.nix
#
{
  lib,
  buildNpmPackage,
